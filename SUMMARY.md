...
* [Defining Music RWAs](learn/objectives.md)
...
* [Protocol Participants](protocol/personas/README.md)
  ...
  * [Relayers](learn/personas/relayers.md)
  * [Copyright/Rights Holders](learn/personas/copyright-rights-holders.md)

## BUILD

* [Technical Overview](build/technical-overview/README.md)
  * [System Architecture](build/technical-overview/system-architecture.md)
  ...
  * [Registries](build/technical-overview/registries/README.md)
    ...
    * [License Registry](build/technical-overview/registries/license-registry.md)
    * [Royalty Claims Registry](build/technical-overview/registries/claimsregistry.md)
  * [Components](build/technical-overview/components/README.md)
    * [Original Works Record types](build/technical-overview/components/assets-rights-and-user-interactions/README.md)
      ...
      * [OW Record: Publication (publishing rights)](build/technical-overview/components/assets-rights-and-user-interactions/ow-record-publication-publishing-rights.md)
      * [OW Record: Release (master rights)](build/technical-overview/components/assets-rights-and-user-interactions/ow-record-release-master-rights.md)
    ...
    * [Royalty Tokens](build/technical-overview/components/royalty-tokens.md)
    * [Royalty Pool](build/technical-overview/components/claims.md)
    * [Packs - Royalty Revenue aggregation](build/technical-overview/components/packs-royalty-revenue-aggregation.md)
    * [Defi Interface Contract (wrapper)](build/technical-overview/components/defi-interface-contract-wrapper.md)
    * [ZK Proofs](build/technical-overview/components/zk-proofs.md)
    * [Data Channels](build/technical-overview/components/data-channels.md)
    * [Ownership tokens and IP governance](build/technical-overview/components/ownership-tokens-and-ip-governance.md)
* [User Interactions](build/user-interactions/README.md)
  * [How it Works](build/user-interactions/how-it-works.md)
  * [Register](build/user-interactions/register.md)
  * [License](build/user-interactions/license.md)
  * [Monetize](build/user-interactions/monetize.md)
  * [On-Chain Royalties](build/user-interactions/royalty-payments/README.md)
    * [Private "on chain" payments](build/user-interactions/royalty-payments/setting-up-private-on-chain-payments.md)
    * [Private Revenue Reports](build/user-interactions/royalty-payments/private-revenue-reports.md)
    * [Making Royalty Payments](build/user-interactions/royalty-payments/making-royalty-payments.md)
    * [Royalty Splits](build/user-interactions/royalty-payments/royalty-splits.md)
  * [Validator roles](build/user-interactions/validator-roles/README.md)
    * [Verifying incoming messages](build/user-interactions/validator-roles/verifying-incoming-messages.md)
    * [Storing structured data on subgraph](build/user-interactions/validator-roles/storing-structured-data-on-subgraph.md)
    * [Validating uniqueness of a Record or License](build/user-interactions/validator-roles/validating-uniqueness-of-a-record-or-license.md)
    * [Reconstructing proofs for historic records](build/user-interactions/validator-roles/reconstructing-proofs-for-historic-records.md)
  * [Accessing Private Information](build/user-interactions/verifiable-zk-proofs/README.md)
    * [Generating Proofs](build/user-interactions/verifiable-zk-proofs/generating-proofs.md)
    * [Using Data Channels](build/user-interactions/verifiable-zk-proofs/data-channels.md)
